...
struct PricingData {
  ...
  var quoteType: PricingData.QuoteType {
    get {return _storage._quoteType}
    set {_uniqueStorage()._quoteType = newValue}
  }

  var marketHours: PricingData.MarketHoursType {
  ...
  var optionsType: PricingData.OptionType {
...
extension PricingData.QuoteType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [PricingData.QuoteType] = [
    .none,
    .altsymbol,
    .heartbeat,
    .equity,
...
extension PricingData.OptionType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [PricingData.OptionType] = [
    .call,
    .put,
  ]
}

extension PricingData.MarketHoursType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [PricingData.MarketHoursType] = [
    .preMarket,
    .regularMarket,
    .postMarket,
    .extendedHoursMarket,
...
extension PricingData: @unchecked Sendable {}
extension PricingData.QuoteType: @unchecked Sendable {}
extension PricingData.OptionType: @unchecked Sendable {}
extension PricingData.MarketHoursType: @unchecked Sendable {}
extension StaticData: @unchecked Sendable {}
...
extension PricingData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _quoteType: PricingData.QuoteType = .none
    var _marketHours: PricingData.MarketHoursType = .preMarket
    ...
    var _optionsType: PricingData.OptionType = .call
...
extension PricingData.QuoteType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "NONE"),
...
extension PricingData.OptionType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "CALL"),
    1: .same(proto: "PUT"),
  ]
...
extension PricingData.MarketHoursType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension StaticData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "StaticData"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    5: .same(proto: "displayName"),
  ]
  ...
  static func ==(lhs: StaticData, rhs: StaticData) -> Bool {
